...
(defn simula-um-dia []
  ...
  ; Funciona, mas já começamos a ter um treco no coração com esse
  ; símbolo global com root binding sendo alterado a rodo
  (pprint hospital)
...
; MUITO CLARO O PROBLEMA DE VARIÁVEL GLOBAL COMPARTILHADO ENTRE THREADS
